...
export function SInstructor(props) {
            ...
            .then(data => {
              ...
              if(data.status == 0){
                    toast({
                        ...
                        description: "We've insert this instructor",
                        status: "success",
                        duration: 9000,
                        isClosable: true,
                        position:"top"
    ...
    return (
        ...
        <Center><HStack maxW="600px" width="400px"><Text color="blue.300">Salary(more than 29000)</Text>
        <Input 
          value={value4}
